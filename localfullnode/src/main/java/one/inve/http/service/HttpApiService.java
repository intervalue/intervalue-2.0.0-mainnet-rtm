...
public class HttpApiService {
    ...
    public String getTransactionList(DataMap<String, Object> data){
        ...
        BigInteger tableIndex = (null==data.getString("tableIndex"))
                ? BigInteger.ZERO : new BigInteger(data.getString("tableIndex"));
        long offset = (null==data.getLong("offset")) ? 0 : data.getLong("offset");

        try {
            TransactionArray trans = CommonApiService
                    .queryTransaction(tableIndex, offset, address, type.toString(), node);
     ...
     * 根据key获取value
     * @param data 键
     *      例： {"key":"328FELEWS/Z4emYTnY9XYf5GDoBJ2iOcwcg1lNWA9uEcRQ9ZqPA31YBzANa2WMd999W7GPELYt6s6D3AThwrxAWw=="}
     * @return 值
     */
    ...
    public String messageHistorySplit(DataMap<String, Object> data){
        ...
        try {
            TransactionArray trans = CommonApiService
                    .queryTransaction(tableIndex, offset,type,  node);
    ...
    public String getSystemAutolist(DataMap<String, Object> data){
        ...
        try {
            SystemAutoArray trans = CommonApiService
                    .querySystemAuto(tableIndex, offset,  node);
     ...
     * @return {"txStatus":true, "gasUsed":"10000", "executionResult":"HEX String", "error":"error String", "logs":"list of logs"}
     */
