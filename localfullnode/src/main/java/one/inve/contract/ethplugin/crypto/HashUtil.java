...
import one.inve.contract.ethplugin.crypto.jce.SpongyCastleProvider;
...
public class HashUtil {
    ...
    /**
     * The way to calculate new address inside ethereum for {@link one.inve.contract.ethplugin.vm.OpCode#CREATE2}
