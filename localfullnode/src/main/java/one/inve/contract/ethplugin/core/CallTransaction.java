...
import one.inve.contract.ethplugin.solidity.SolidityType;
...
import static one.inve.contract.ethplugin.solidity.SolidityType.IntType;
import static one.inve.contract.ethplugin.util.ByteUtil.longToBytesNoLeadZeroes;
