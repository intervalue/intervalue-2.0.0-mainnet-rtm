 ...
 */
package one.inve.contract.ethplugin.config.net;

import one.inve.contract.ethplugin.config.blockchain.Eip150HFConfig;
import one.inve.contract.ethplugin.config.blockchain.Eip160HFConfig;
import one.inve.contract.ethplugin.config.blockchain.MordenConfig;
