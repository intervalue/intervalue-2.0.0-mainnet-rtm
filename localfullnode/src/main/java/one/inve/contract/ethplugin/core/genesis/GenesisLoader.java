 ...
 */
package one.inve.contract.ethplugin.core.genesis;
...
import one.inve.contract.ethplugin.db.ByteArrayWrapper;
...
import static one.inve.contract.ethplugin.core.BlockHeader.NONCE_LENGTH;
import static one.inve.contract.ethplugin.core.Genesis.PremineAccount;
import static one.inve.contract.ethplugin.core.Genesis.ZERO_HASH_2048;
import static one.inve.contract.ethplugin.crypto.HashUtil.EMPTY_LIST_HASH;
import static one.inve.contract.ethplugin.util.ByteUtil.*;
