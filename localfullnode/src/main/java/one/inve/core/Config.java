...
public class Config {
    ...
    /**
     Francis.Deng 4/5/2019 AIASTTDTUOH
     aws ip addresses switch to these due to upgrade of hardware:
     -------------------------------------------------------------
     From           To
     Singapore  13.250.14.98   singapore.trilliontrust.com
     Virginia   3.94.202.66    virginia.trilliontrust.com
     Frankfurt  3.121.162.184  frankfurt.trilliontrust.com
     Sydney     13.211.5.129   sydney.trilliontrust.com
     Oregen     54.213.84.89   oregen.trilliontrust.com
     seed       34.220.63.1    seed.trilliontrust.com
     */
...
//            "{\"nrgPrice\":\"1000000000\",\"amount\":\"630356661000000000000000000\",\"signature\":\"32UamG+bEpIssBmgJGoUgZCSo4ImI/X+EsuRA85N2LXhcyam60KWhtx/BV5dV97nTIh5hSSO5iRtMhbIijdGw/xg==\",\"fee\":\"500000\",\"vers\":\"2.0\",\"fromAddress\":\"CMUORK2YLSE4UA6C6DSFVMRPGWKWH3QH\",\"remark\":\"\",\"type\":1,\"toAddress\":\"RTJXP4HUFIZDHO7EQLPNMOLTQREQ2SVC\",\"timestamp\":1550637677588,\"pubkey\":\"Ap6hlAbGc/0iup4uTuekC+WIK21pNo700yZVXV69wmx+\"}"
    ...
    public static final List<String> WHITE_LIST = Arrays.asList(
            /**
             ...
             seed       34.220.63.1    seed.trilliontrust.com
             */
            "singapore.trilliontrust.com",
            "virginia.trilliontrust.com",
            "frankfurt.trilliontrust.com",
            "sydney.trilliontrust.com",
            "oregen.trilliontrust.com",
    ...
    // rpc服务
    public static final String[] SERVICE_ARRAY = {
            "one.inve.rpcimpl.localfullnode.Light2localImpl",
