...
public class Cryptos {
    ...
    static final String SIG_TYPE2 =
            Config.useRSA ? "SHA384withRSA" : "SHA384withECDSA";
    ...
    static KeyPair[] generateKeyPairs(int n) {
        ...
        try {
            KeyPairGenerator keyGen =
                    KeyPairGenerator.getInstance(SIG_TYPE2, SIG_PROVIDER);
    ...
    static Future<Boolean> verifySignatureParallel(byte[] data, final byte[] signature,
