...
import one.inve.contract.ethplugin.datasource.DataSourceArray;
import one.inve.contract.ethplugin.datasource.ObjectDataSource;
import one.inve.contract.ethplugin.datasource.Serializer;
...
import static one.inve.contract.ethplugin.crypto.HashUtil.shortHash;
