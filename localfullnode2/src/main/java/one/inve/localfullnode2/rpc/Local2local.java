...
public interface Local2local extends com.zeroc.Ice.Object {
	GossipObj gossipMyMaxSeqList4Consensus(String pubkey, String sig, String snapVersion, String snapHash, long[] seqs,
			com.zeroc.Ice.Current current);

	GossipObj gossipMyMaxSeqList4Sync(String pubkey, String sig, int otherShardId, String snapVersion, String snapHash,
			long[] seqs, com.zeroc.Ice.Current current);
	...
	boolean gossipReport4split(String pubkey, String sig, String data, int shardId, String event,
			com.zeroc.Ice.Current current);
	...
	static java.util.concurrent.CompletionStage<com.zeroc.Ice.OutputStream> _iceD_gossipMyMaxSeqList4Consensus(
			Local2local obj, final com.zeroc.IceInternal.Incoming inS, com.zeroc.Ice.Current current) {
		...
		inS.endReadParams();
		GossipObj ret = obj.gossipMyMaxSeqList4Consensus(iceP_pubkey, iceP_sig, iceP_snapVersion, iceP_snapHash,
				iceP_seqs, current);
	...
	static java.util.concurrent.CompletionStage<com.zeroc.Ice.OutputStream> _iceD_gossipMyMaxSeqList4Sync(
			Local2local obj, final com.zeroc.IceInternal.Incoming inS, com.zeroc.Ice.Current current) {
		com.zeroc.Ice.Object._iceCheckMode(null, current.mode);
		com.zeroc.Ice.InputStream istr = inS.startReadParams();
		String iceP_pubkey;
		...
		iceP_seqs = istr.readLongSeq();
		inS.endReadParams();
		GossipObj ret = obj.gossipMyMaxSeqList4Sync(iceP_pubkey, iceP_sig, iceP_otherShardId, iceP_snapVersion,
				iceP_snapHash, iceP_seqs, current);
		com.zeroc.Ice.OutputStream ostr = inS.startWriteParams();
		GossipObj.ice_write(ostr, ret);
		inS.endWriteParams(ostr);
		return inS.setResult(ostr);
	...
	static java.util.concurrent.CompletionStage<com.zeroc.Ice.OutputStream> _iceD_gossipMySnapVersion4Snap(
			Local2local obj, final com.zeroc.IceInternal.Incoming inS, com.zeroc.Ice.Current current) {
		com.zeroc.Ice.Object._iceCheckMode(null, current.mode);
		com.zeroc.Ice.InputStream istr = inS.startReadParams();
		String iceP_pubkey;
	...
	static java.util.concurrent.CompletionStage<com.zeroc.Ice.OutputStream> _iceD_gossip4AppointEvent(Local2local obj,
		...
		inS.endReadParams();
		AppointEvent ret = obj.gossip4AppointEvent(iceP_pubkey, iceP_sig, iceP_shardId, iceP_creatorId, iceP_creatorSeq,
				current);
		com.zeroc.Ice.OutputStream ostr = inS.startWriteParams();
	...
	static java.util.concurrent.CompletionStage<com.zeroc.Ice.OutputStream> _iceD_gossipReport4split(Local2local obj,
			final com.zeroc.IceInternal.Incoming inS, com.zeroc.Ice.Current current) {
		com.zeroc.Ice.Object._iceCheckMode(null, current.mode);
		com.zeroc.Ice.InputStream istr = inS.startReadParams();
		String iceP_pubkey;
	...
	static java.util.concurrent.CompletionStage<com.zeroc.Ice.OutputStream> _iceD_gossip4SplitDel(Local2local obj,
			final com.zeroc.IceInternal.Incoming inS, com.zeroc.Ice.Current current) {
		com.zeroc.Ice.Object._iceCheckMode(null, current.mode);
		com.zeroc.Ice.InputStream istr = inS.startReadParams();
		String iceP_pubkey;
		...
		inS.endReadParams();
		boolean ret = obj.gossip4SplitDel(iceP_pubkey, iceP_sig, iceP_data, iceP_shardId, iceP_creatorId,
				iceP_creatorSeq, iceP_eventHash, iceP_isNeedGossip2Center, current);
		com.zeroc.Ice.OutputStream ostr = inS.startWriteParams();
		ostr.writeBool(ret);
		inS.endWriteParams(ostr);
		return inS.setResult(ostr);
	...
	default java.util.concurrent.CompletionStage<com.zeroc.Ice.OutputStream> _iceDispatch(
			com.zeroc.IceInternal.Incoming in, com.zeroc.Ice.Current current) throws com.zeroc.Ice.UserException {
