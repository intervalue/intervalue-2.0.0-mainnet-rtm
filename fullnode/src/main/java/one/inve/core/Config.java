...
/**
 * 配置参数常量类
 * Created by Clare  on 2018/7/19 0019.
 */
public class Config {
...
//    public static final String DEFAULT_SEED_PUBIPa = "35.170.77.230";
...
//    public static final String DEFAULT_SEED_PUBIP = "172.17.2.118";
     ...
     * 黑名单
     */
    public static final List<String> DEFAULT_BLACK_LIST = Arrays.asList(
            "117.149.24.124"
    );
     ...
     * 提供的rpc服务列表
     */
    public static final List<String> RPC_SERVICE_NAMES = Arrays.asList(
            "one.inve.rpcImpl.fullnode.RegisterRpcImpl"
    );
}
