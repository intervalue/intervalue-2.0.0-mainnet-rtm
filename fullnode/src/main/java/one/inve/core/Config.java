...
/**
 * 配置参数常量类 Created by Clare on 2018/7/19 0019.
 */
public class Config {
	 ...
	 * seed全节点地址信息
	 */
	public static final String DEFAULT_SEED_PUBIP = "192.168.207.130";
...
//    public static final String DEFAULT_SEED_PUBIP = "172.17.2.118";
	...
	public static final List<String> DEFAULT_WHITE_LIST = Arrays.asList(
			...
			"52.221.119.220", "3.213.114.163", "3.121.158.99", "3.105.17.5", "52.38.78.194", "192.168.207.130");
